<header class="banner">
      ...
      <div id="logo" class="container-fluid">
        <div class="container">
          <div class="row justify-content-start no-gutters logo-titulo">
            <a href="{{ home_url('/') }}" class="brand col-1 col-md-2 col-lg-1">
              <svg version="1.1" viewBox="0 0 203 231" xml:space="preserve" xmlns="http://www.w3.org/2000/svg" class="svg-logo">
            ...
            <h1 class="brand col-9 col-md-6 col-lg-6">
