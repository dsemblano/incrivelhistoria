<header class="banner">
      ...
      <div id="logo" class="container-fluid">
        <div class="container">
          <div class="row justify-content-start no-gutters">
            <a href="{{ home_url('/') }}" class="brand col-1">
    ...
    {{-- <a class="brand" href="{{ home_url('/') }}">{{ get_bloginfo('name', 'display') }}</a> --}}
      ...
      <nav class="nav-primary nav-primary-main container-fluid">
        @if (has_nav_menu('secondary_navigation'))
          {!! wp_nav_menu(['theme_location' => 'secondary_navigation', 'menu_class' => 'nav container']) !!}
        @endif
      </nav>
