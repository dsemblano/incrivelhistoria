...
class Plf_filter
{
    ...
    public function active_sitewide_plugins($default = false)
    {
    ...
    public function active_jetmodules($default = false)
    {
        return $this->plf_filter('jetpack_active_modules', $default);
    }

    //Celtispack module Filter
    public function active_celtismodules($default = false)
    {
    ...
    public function force_initial_taxonomies()
    {
        global $wp_actions;
        $wp_actions[ 'init' ] = 1;
    ...
    public function cache_post_type()
    {
        ...
        } elseif (!empty($data['post_type_query_vars']) || !empty($data['queryable_post_types'])) {
    ...
    public function plf_filter($option, $default = false)
    {
